 ...
 */
public class ForceExitDialogFragment extends DialogFragment {
    ...
    public static ForceExitDialogFragment newInstance(@Nullable String title, @Nullable String msg) {

        Bundle args = new Bundle();
        args.putString(ARG_TITLE,title);
        args.putString(ARG_MSG,msg);
        ForceExitDialogFragment fragment = new ForceExitDialogFragment();
        fragment.setArguments(args);
        return fragment;
    }


    public ForceExitDialogFragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        rootView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_update_dialog, null);
